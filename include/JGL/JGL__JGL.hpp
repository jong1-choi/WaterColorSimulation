...
#include "JGL/JGL__Math.hpp"
#include "JGL/JGL__String.hpp"
...
struct _JGL {
	...
	static float			getCurrentDrawWindowUIRatio();
	...
	static void				runOnUIThread(std::function<void(void*ud)> func, void* ud=nullptr);
...
protected:
	...
	static queue<_RunOnUIThreadItem> _runOnUIThreadQueue;
	...
	static void			contentsScaleCallback( GLFWwindow* win, float, float );
