...
struct Window : public Group, public _PopupHandler {
	...
	virtual vec3		windowGamma() const;
	virtual mat3		windowColorMat() const;
...
protected:
	...
	vec3			_windowGamma	= vec3(2.4f);
	mat3			_windowColorMat	= mat3(1);
